...
define('SECRET_SALT','05A3iXdb9QwGsdngI002Rz2hVULWMAA0');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','housefull047@gmail.com');
...
define('DBNAME','osticketregister');
define('DBUSER','osticketregister');
define('DBPASS','Cdac@123');
