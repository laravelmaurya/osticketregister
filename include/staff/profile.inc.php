...
// $(function(){
//   $(document).on('blur','#change-pw-button', function(){
//     console.log('type');
//     $(".passwd1_password").prop('type','hidden');
//   });
// });

$(function(){
  $(document).on('blur','#change-pw-button', function(){
    $(".current_password").prop('type','hidden');
    $(".passwd1").prop('type','hidden');
    $(".passwd2").prop('type','hidden');
  });
});

$(function(){
  $(document).on('change','.current_encript_password', function(){
    
    console.log('on change get value feom class current_password=');
    // $(".current_encript_password").prop('type','hidden');
    syncForCurrentPassword()
  });
});

$(function(){
  $(document).on('change','.passwd1_encript', function(){
    
    console.log('on change get value feom class passwd1_encript=');
    // $(".current_encript_password").prop('type','hidden');
    syncForNewPassword()
  });
});
...
$(function(){
  $(document).on('change','.passwd2_encript', function(){
    
    console.log('on change get value feom class passwd2_encript=');
    // $(".current_encript_password").prop('type','hidden');
    syncForConfirmPassword()
  });
});
   ...
   function syncForCurrentPassword()
    {
        // var passwordInput = document.getElementsByClassName("current_password").value;

        var passwordInput = $('.current_encript_password').val();
        // var encodedPasswordInput = document.getElementsByClassName("current_password");
        ...
        var encodedPasswordInput = $('.current_password').val(encodedData);
        $(".current_encript_password").removeAttr("name");
        alert(encodedPasswordInput);



    }
    function syncForNewPassword()
    {
        // var passwordInput = document.getElementsByClassName("current_password").value;

        var passwordInput = $('.passwd1_encript').val();
        // var encodedPasswordInput = document.getElementsByClassName("current_password");
        ...
        encodedData= CryptoJS.SHA256(btoa(String.fromCharCode.apply(null, data)));
        var encodedPasswordInput = $('.passwd1').val(encodedData);
        $(".passwd1_encript").removeAttr("name");
        alert(encodedPasswordInput);
    ...
    function syncForConfirmPassword()
    {
      var passwordInput = $('.passwd2_encript').val();
        // var encodedPasswordInput = document.getElementsByClassName("current_password");
        ...
        encodedData= CryptoJS.SHA256(btoa(String.fromCharCode.apply(null, data)));
        var encodedPasswordInput = $('.passwd2').val(encodedData);
        $(".passwd2_encript").removeAttr("name");
        alert(encodedPasswordInput);
